      ...
      <button
        ...
        className={`${
          open === id
            ...
            : `${bg} text-black`
        } transition-colors px-5 flex flex-col-reverse lg:flex-col justify-center items-center gap-4 relative group shadow border-l border-panel-border text-panel-text`}
        onClick={() => setOpen(id)}
      >
